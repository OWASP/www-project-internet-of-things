...
|---|---|---|
 <img width="250"/> [IoT Top 10 ](https://www.owasp.org/index.php/OWASP_Internet_of_Things_Project#tab=IoT_Top_10) | <img width="210"/> Daniel Miessler <br/> Aaron Guzman  <br/> Vishruta Rudresh <br/> Craig Smith | <br/> Top ten things to avoid when building, deploying or managing IoT systems.
...
|  **Project** | **Project Leader(s)** | **Description** |
|---|---|---|
<img width="250"/> Catalogue of IoT regulatory policies and Certifications| <img width="210"/> TBD | TBD
